...
Route::get("/add-shoe","MyShoeController@addShoe")->name("addShoe")->middleware("auth");
Route::post("/upload-shoe","MyShoeController@uploadShoe")->name("uploadShoe")->middleware("auth");
